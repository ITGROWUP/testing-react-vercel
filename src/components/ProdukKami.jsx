...
const ProdukKami = () => {
  return (
    <div className='flex flex-col lg:flex-row justify-around items-center px-5 md:px-10 lg:px-20 bg-[url("./assets/bg_1.png")] w-full bg-cover bg-center relative'>
      <div className="h-auto lg:h-[100vh] flex flex-col py-20 lg:py-[20%] text-center lg:text-left">
      ...
      <div className="w-full lg:w-[60%] h-auto lg:h-[100vh] flex items-center justify-center lg:items-end">
