...
const Ecommerce = () => {
  return (
    <div id="barang" className="flex flex-wrap justify-center px-5 py-10 gap-6 md:px-10 lg:gap-8 lg:px-20 lg:py-20">
      {/* Card 1 */}
       <div data-aos="flip-right" data-aos-duration="800" className="w-full sm:w-[48%] md:w-[30%] lg:w-[20%] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-lg">
        ...
        <div className="p-2">
          ...
          <a href="https://api.whatsapp.com/send?phone=6287845620888&text=Halo%20Antorma." className="bg-orange-500 w-full text-white p-2 mt-2 rounded-[5px] flex justify-center items-center gap-1">
      ...
      <div data-aos="flip-right" data-aos-duration="800" className="w-full sm:w-[48%] md:w-[30%] lg:w-[20%] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-lg">
       ...
       {/* Card 7 */}
       <div data-aos="flip-right" data-aos-duration="800" className="w-full sm:w-[48%] md:w-[30%] lg:w-[20%] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-lg">
        <img className="w-full rounded-t-lg" src={lemari} alt="Meja 3" />
        <div className="p-2">
          <h3 className="text-[16px] md:text-[18px] lg:text-[20px] font-bold">
            Lemari pakaian premium
          </h3>
          <h3 className="text-[16px] md:text-[18px] lg:text-[20px] font-bold text-orange-500">
            Rp 960.000,-
          </h3>
          <div className="flex gap-2 items-center mt-5">
            <span className="material-icons text-yellow-600">star</span>
            <p className="text-gray-400 text-sm">4.9 | 231 Terjual</p>
          </div>
          <div className="flex gap-2 items-center mt-2">
            <p className="text-gray-400 text-sm">Stock banyak</p>
          </div>
          <a href="https://api.whatsapp.com/send?phone=6287845620888&text=Halo%20Antorma." className="bg-orange-500 w-full text-white p-2 mt-2 rounded-[5px] flex justify-center items-center gap-1">
            <span className="material-symbols-outlined">shopping_cart</span> Check
            Out
       ...
       {/* Card 8 */}
       <div data-aos="flip-right" data-aos-duration="800" className="w-full sm:w-[48%] md:w-[30%] lg:w-[20%] shadow-[rgba(50,_50,_105,_0.15)_0px_2px_5px_0px,_rgba(0,_0,_0,_0.05)_0px_1px_1px_0px] rounded-lg">
        <img className="w-full rounded-t-lg" src={lampu} alt="Meja 3" />
        <div className="p-2">
          <h3 className="text-[16px] md:text-[18px] lg:text-[20px] font-bold">
            Lampup Ruang tamu
          </h3>
          ...
          <div className="flex gap-2 items-center mt-5">
            <span className="material-icons text-yellow-600">star</span>
            <p className="text-gray-400 text-sm">4.6 | 106 Terjual</p>
          </div>
          <div className="flex gap-2 items-center mt-2">
            <p className="text-gray-400 text-sm">Stock banyak</p>
          </div>
